...
namespace SpeaTestDataTestEvents {
        ...
        public static void Main() {
            try {
                ...
                for (int i = 1; i <= numberOfBoards; i++) {
                    ...
                    if ((testEvent != "NA") && (serialNumber != "NA")) TestEvent.PseudoMain(new string[] { partNumber, serialNumber, testEvent });
                }
            } catch (Exception e) {
    ...
    public static class TestEvent {
        ...
        public static void SaveException(string exception) {
            string e = exception.Substring(0, Math.Min(1024, exception.Length));  // Truncate exception to 1024 characters, since its SQL field is 1024 characters max.
